  ...
  render() {
    return (
      <Helmet>
        ...
        <meta property="og:title" content={`Fact Check: ${this.props.sourceTitle}`} />
        <meta property="og:description" content={"Have you been reading fact or fiction? Click here to find out."} />
