...
interface FcErrorMessageProps extends WithStylesProps<typeof styles>, WithThemeProps {
  id: string;
  msg?: string;
}
...
class FcErrorMessage extends PureComponent<FcErrorMessageProps> {
  render() {
...
export default withStyles(styles)(withTheme(FcErrorMessage));
