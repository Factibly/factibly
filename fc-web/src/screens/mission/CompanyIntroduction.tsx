  ...
  return (
    <>
      <Typography gutterBottom variant="h4" component="h2">
        {intl.formatMessage({ id: "app.organization" })}
      </Typography>
      <Typography variant="body1">
        ...
        <a href="https://www.un.org/en/un-coronavirus-communications-team/un-tackling-%E2%80%98infodemic%E2%80%99-misinformation-and-cybercrime-covid-19">
          acknowledged
        </a>
