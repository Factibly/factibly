...
export function isSupportText(arg: any): arg is SupportText {
  return arg.discriminator === "support-text";
}
...
const supportPrompts: SupportPrompts = {
  ...
  help: {
    ...
    topics: [
      "support.help.topic.accessibility",
      "support.help.topic.account.fraud",
      "support.help.topic.account.inappDisplayName",
      "support.help.topic.account.multiAccount",
      "support.help.topic.account.privacy",
      "support.help.topic.account.settings",
      "support.help.topic.discriminatory.employees",
      "support.help.topic.discriminatory.users",
      "support.help.topic.diversity",
      "support.help.topic.factCheck.inAppComments",
      "support.help.topic.factCheck.query",
      "support.help.topic.factCheck.spam",
      "support.help.topic.harassment.employees",
      "support.help.topic.harassment.users",
      "support.help.topic.nav.issue",
      "support.help.topic.search.misleading",
    ],
    helperTexts: {
  ...
  feedback: {
    ...
    icon: FeedbackIcon,
    topics: [
      "support.feedback.topic.accessibility",
      "support.feedback.topic.account.customization",
      "support.feedback.topic.account.registrationProcess",
      "support.feedback.topic.factCheck.gradingSystem",
      "support.feedback.topic.factCheck.readershipTrends",
      "support.feedback.topic.factCheck.userRatings",
      "support.feedback.topic.localization",
      "support.feedback.topic.privacy",
      "support.feedback.topic.search",
      "support.feedback.topic.security",
      "support.feedback.topic.support",
    ],
    helperTexts: {
      topic: "support.form.field.topic.help",
    },
  ...
  bug: {
    ...
    icon: BugReportIcon,
    topics: ["support.bugReport.topic.ui", "support.bugReport.topic.ux"],
    helperTexts: {
      topic: "support.form.field.topic.help",
