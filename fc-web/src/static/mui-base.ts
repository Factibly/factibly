...
export const azAZ: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} dən ${count !== -1 ? count : `more than ${to}`}`,
...
export const bgBG: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} от ${count !== -1 ? count : `more than ${to}`}`,
...
export const deDE: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} von ${count !== -1 ? count : `more than ${to}`}`,
...
export const idID: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} dari ${count !== -1 ? count : `more than ${to}`}`,
...
export const isIS: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} af ${count !== -1 ? count : `more than ${to}`}`,
...
export const nlNL: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} van ${count !== -1 ? count : `more than ${to}`}`,
...
export const roRO: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} din ${count !== -1 ? count : `more than ${to}`}`,
...
export const svSE: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} av ${count !== -1 ? count : `more than ${to}`}`,
...
export const zhCN: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} 的 ${count !== -1 ? count : `超过 ${to}`}`,
...
export const zhTW: Localization = {
  props: {
    ...
    MuiTablePagination: {
      ...
      labelDisplayedRows: ({ from, to, count }) => `${from}-${to} 的 ${count !== -1 ? count : `超過 ${to}`}`,
